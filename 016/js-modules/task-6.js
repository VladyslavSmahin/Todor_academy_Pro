...
///Идея была такая - Создать обьект, где будут обьекты пользователей с данными ,где имя и год рождения нельзя форматировать,а только смотреть , а почту можно заменять